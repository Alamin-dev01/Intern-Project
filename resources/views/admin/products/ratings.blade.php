                ...
                <form action="" method="get">
                    <div class="card-header">
                        ...
                        <div class="card-title">
                            <button type="button" onclick="window.location.href='{{route("products.productRatings")}}' " class="btn btn-defult btn-sm">Reset</button>
                        </div>
...
<script>
    ...
    function changeStatus(status,id){
        if (confirm("Are ypu sure, you want to change status?")){
            $.ajax({
