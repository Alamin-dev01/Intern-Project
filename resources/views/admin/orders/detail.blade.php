                    ...
                    <div class="card-header pt-3">
                        <div class="row invoice-info">
                            ...
                            <div class="col-sm-4 invoice-col">
                                ...
                                <b>Status:</b> 
                                @if($order->status == 'pending') <!-- Corrected 'panding' to 'pending' -->
...
$(document).ready(function(){
    ...
    if (confirm("Arwe you sure, you want to change status?")) {
...
$("#sendInvoiceEmail").submit(function(event){
    ...
    if (confirm("Arwe you sure, you want to change status?")) {
        $.ajax({
    url: '{{ route("orders.sendInvoiceEmail", $order->id) }}',  // Ensure correct route and order ID
